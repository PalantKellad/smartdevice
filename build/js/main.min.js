...
/* harmony import */ var _modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/accordion/init-accordion */ "./js/modules/accordion/init-accordion.js");
/* harmony import */ var _modules_phone_mask_phone_mask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/phone-mask/phone-mask */ "./js/modules/phone-mask/phone-mask.js");
/* harmony import */ var _modules_show_more_show_more__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/show-more/show-more */ "./js/modules/show-more/show-more.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    Object(_modules_phone_mask_phone_mask__WEBPACK_IMPORTED_MODULE_3__["initPhoneMask"])();
  });
});
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_2__["initAccordions"])();
  });
});
...
Object(_modules_show_more_show_more__WEBPACK_IMPORTED_MODULE_4__["showMore"])();
...
var Accordions = /*#__PURE__*/function () {
  ...
  _createClass(Accordions, [{
    ...
    value: function openAccordion(element) {
      ...
      var buttonElement = element.querySelector('[data-accordion="button"]');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Modals", function() { return Modals; });
/* harmony import */ var _scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scroll-lock */ "./js/modules/modals/scroll-lock.js");
/* harmony import */ var _focus_lock__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./focus-lock */ "./js/modules/modals/focus-lock.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
/* harmony import */ var _ios_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ios-checker */ "./js/modules/modals/ios-checker.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
function showMore() {
  var element = document.querySelector('.about__wrapper');
  var button = document.querySelector('button[data-more-button]');
  if (element) {
    var elementStyles = window.getComputedStyle(element);
    var elementPropertyLH = elementStyles.getPropertyValue('line-height');
    var lineHeight = parseInt(elementPropertyLH, 10);
    var linesCount = getComputedStyle(element).getPropertyValue('--visible-lines-count');
    var visibleHeight = linesCount * lineHeight;
    if (button) {
      element.style.maxHeight = "".concat(visibleHeight, "px");
      button.addEventListener('click', function () {
        if (element.style.maxHeight === "".concat(visibleHeight, "px")) {
