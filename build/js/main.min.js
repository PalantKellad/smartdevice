...
function showMore() {
  var smallTextElement = document.querySelector('.about__wrapper [data-more-text="small"]');
  var button = document.querySelector('button[data-more-button]');
  if (smallTextElement) {
    var maxHeight = getComputedStyle(smallTextElement).getPropertyValue('--max-height');
    if (button) {
      if (maxHeight === 0) {
